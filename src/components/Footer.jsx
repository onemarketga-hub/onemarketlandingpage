    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-2 text-sm text-gray-400">
              <span>1000+ {language === 'fr' ? 'Prestataires' : 'Providers'}</span>
              <span>•</span>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:info@onemarket.ga" className="text-gray-300 hover:text-white transition-colors">
                  info@onemarket.ga
                </a>
              </li>
              <li>
                <a href="tel:+241077854048" className="text-gray-300 hover:text-white transition-colors">
                  +241 077 854 048
                </a>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex gap-4">
              <a href="https://www.facebook.com/share/17HSQWdnPF/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" aria-label="Facebook">
            ...
            <p className="text-gray-400 text-sm">
              {language === 'fr' ? 'Fait avec amour au Gabon' : 'Made with love in Gabon'}
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} OneMarket. {language === 'fr' ? 'Tous droits réservés.' : 'All rights reserved.'}
          </p>
        </div>
      </div>
    </footer>
